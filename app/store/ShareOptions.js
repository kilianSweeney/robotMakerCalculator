	...
	autoLoad: true,
		...
		{ title: 'EMAIL', fc: function(solutionStr,typeStr) {
				var 	subject = "Robot Maker Calculator solution coming your way",			
					mailTo,
					sendStr = '';
				solutionStr = typeStr.indexOf('about') > -1 ? (solutionStr + '%20http://' + motioncalc.app.siteLanding) : solutionStr;
			...
			fc: function(solutionStr,typeStr) {
					...
					sendStr += "&link=http://"+motioncalc.app.siteLanding+"";
					sendStr += "&picture=http://"+motioncalc.app.siteURL+"/resources/icons/motioncalc/squareicon57.png";
		...
		{ title: 'TWITTER', fc: function(solutionStr,typeStr) {				
				var 	url = typeStr.indexOf('about') > - 1 ? motioncalc.app.siteLanding : motioncalc.app.siteTiny,
